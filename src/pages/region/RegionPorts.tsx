...
export function RegionPorts() {
  ...
  const regionPorts = ports.filter(p => p.region === regionId);
  ...
  return (
    <div className="w-full bg-plimsoll min-h-screen">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        {isLoading ? (
          <div className="py-24 text-center text-steel">Loading ports...</div>
        ) : error ? (
          <div className="py-24 text-center text-red-500">Failed to load ports.</div>
        ) : (
